        ...
        <div className="mx-auto max-w-[980px]">
            ...
            <Panel className="min-h-[620px]">
                        ...
                        <div className="rounded-2xl border border-[#dbe3ef] bg-[#f8fafc] p-5">
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="mt-2 text-[#64748b]">Upload a chart or ask about trend, support, resistance, entry quality, invalidation, and risk management.</p>
                                </div>
                            </div>
                        </div>
                    )}
                    {messages.map((message) => (
                        <div key={message.id} className={`rounded-2xl p-4 ${message.role === "user" ? "ml-auto max-w-[80%] bg-[#3457ff] text-white shadow-[0_14px_28px_rgba(52,87,255,0.18)]" : "mr-auto max-w-[85%] border border-[#dbe3ef] bg-[#f8fafc]"}`}>
                ...
                <form onSubmit={submit} className="mt-8 flex gap-3">
                    <input name="content" required className="flex-1 rounded-xl border border-[#dbe3ef] bg-[#f8fafc] px-4 py-3 outline-none transition-colors placeholder:text-[#94a3b8] focus:border-[#3457ff] focus:bg-white" placeholder="Ask about a setup..." />
