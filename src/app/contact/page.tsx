                    ...
                    <Container>
                        <div className="grid items-center gap-10 lg:grid-cols-[0.9fr_1.1fr]">
                            <div>
                                ...
                                <h1 className="max-w-3xl text-5xl font-extrabold leading-tight text-[#101828] md:text-6xl">
                                ...
                                <div className="mt-8 grid max-w-2xl gap-3 sm:grid-cols-3">
                                    <Info icon={<FiMail />} title="Email" text="support@gptchartview.com" />
                                    <Info icon={<FiClock />} title="Response" text="Usually same business day" />
                                    <Info icon={<FiShield />} title="Secure" text="Server-side SMTP only" />
                                </div>
                                <div className="mt-8 rounded-[2rem] bg-[#101828] p-6 text-white">
                                    <h2 className="flex items-center gap-2 text-xl font-extrabold"><FiMessageSquare /> Already a member?</h2>
                                    ...
                                    <Link href="/dashboard/support" className="mt-5 inline-flex rounded-full bg-primary px-6 py-3 font-extrabold text-black">
...
const Info = ({ icon, title, text }: { icon: React.ReactNode; title: string; text: string }) => (
    <div className="rounded-2xl border border-[#d9e2ef] bg-white p-4 shadow-sm">
        ...
        <p className="mt-1 font-extrabold text-[#101828]">{text}</p>
    </div>
);
