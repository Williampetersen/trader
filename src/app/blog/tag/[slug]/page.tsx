                ...
                <section className="py-14">
                    <Container>
                        ...
                        <div className="rounded-[28px] border border-black/[0.08] bg-white p-6 md:p-10">
                            ...
                            <h1 className="mt-5 max-w-4xl break-words text-4xl font-semibold leading-tight text-ink sm:text-5xl md:text-6xl">{tag}</h1>
                    ...
                    <Container>
                        ...
                        <div className="mt-10 grid gap-6 lg:grid-cols-[1fr_360px]">
                            ...
                            <div className="rounded-[28px] bg-ink p-6 text-white">
                                ...
                                <p className="mt-3 text-white/70">Use the member dashboard to upload chart screenshots, save AI notes, and track outcomes.</p>
