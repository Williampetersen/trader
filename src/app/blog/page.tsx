    ...
    <>
        ...
        <main className="bg-canvas pt-28">
                ...
                <Container>
                    <div className="grid items-end gap-8 lg:grid-cols-[1fr_0.65fr]">
                        <div>
                            ...
                            <h1 className="max-w-4xl break-words text-4xl font-semibold leading-tight text-ink sm:text-5xl md:text-6xl">
                        ...
                        <div className="rounded-[28px] bg-ink p-6 text-white">
                            <p className="text-sm font-semibold text-[#2997ff]">In this blog</p>
            ...
            <section className="pb-10">
                <Container>
                    <div className="rounded-[28px] border border-black/[0.08] bg-white p-5 md:p-7">
                        <div className="mb-5 flex items-center gap-2">
                            <FiGrid className="text-accent" />
                            <h2 className="text-2xl font-semibold text-ink">Browse by topic</h2>
                        </div>
                        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                            {blogCategories.map((category) => (
                                <Link key={category.slug} href={`/blog/category/${category.slug}`} className="rounded-2xl border border-black/[0.08] bg-canvas p-4 transition-colors hover:border-accent hover:bg-white">
                                    <h3 className="font-semibold text-ink">{category.name}</h3>
                                    <p className="mt-2 text-sm text-muted">{category.description}</p>
                                    <span className="mt-4 inline-flex items-center gap-2 text-sm font-semibold text-accent">Explore <FiArrowRight /></span>
                                </Link>
                            ))}
                        </div>
                    </div>
            ...
            <section className="py-10">
                <Container>
                    ...
                    <div className="mt-8 rounded-[28px] border border-black/[0.08] bg-white p-5">
                        <h2 className="text-2xl font-semibold text-ink">Popular tags</h2>
