                            ...
                            <div className="grid gap-8 lg:grid-cols-[1fr_360px]">
                                <div>
                                    <div className="mb-5 flex flex-wrap gap-2">
                                        <Link href={`/blog/category/${article.category.slug}`} className="rounded-full bg-[#eef2ff] px-4 py-2 text-sm font-semibold text-[#304fff]">{article.category.name}</Link>
                                    ...
                                    <h1 className="max-w-5xl break-words text-4xl font-semibold leading-tight text-[#101828] sm:text-5xl md:text-6xl">{article.title}</h1>
                                ...
                                <aside className="rounded-[2rem] bg-[#101828] p-6 text-white">
                                    <p className="text-sm font-semibold uppercase tracking-[0.18em] text-primary">Direct answer</p>
                                    <p className="mt-4 text-lg leading-7 text-[#f2f4f7]">{article.directAnswer}</p>
                                    <Link href="/signup" className="mt-6 inline-flex w-full items-center justify-center gap-2 rounded-2xl bg-primary px-5 py-3 font-semibold text-black">
                                        Analyze your chart
                                        <FiArrowRight />
                                    </Link>
                                </aside>
                    ...
                    <Container>
                        <div className="grid gap-10 lg:grid-cols-[minmax(0,1fr)_320px]">
                            <div className="rounded-[2rem] border border-[#d9e2ef] bg-white p-6 text-lg leading-8 text-[#344054] md:p-10">
                                <section>
                                    <h2 className="text-3xl font-semibold text-[#101828]">Introduction</h2>
                                ...
                                {article.sections.map((section) => (
                                    <section key={section.h2} className="mt-12 scroll-mt-28" id={slugify(section.h2)}>
                                        <h2 className="text-3xl font-semibold text-[#101828]">{section.h2}</h2>
                                        <p className="mt-4">{section.intro}</p>
                                        <h3 className="mt-7 text-2xl font-semibold text-[#101828]">{section.h3}</h3>
                                ...
                                <section className="mt-12">
                                    <h2 className="text-3xl font-semibold text-[#101828]">Practical examples</h2>
                                    <div className="mt-6 grid gap-5">
                                        {article.examples.map((example) => (
                                            <div key={example.title} className="rounded-3xl border border-[#d9e2ef] bg-[#f8fafc] p-5">
                                                <h3 className="text-2xl font-semibold text-[#101828]">{example.title}</h3>
                                ...
                                <section className="mt-12">
                                    <h2 className="text-3xl font-semibold text-[#101828]">Frequently asked questions</h2>
                                    <div className="mt-6 divide-y divide-[#d9e2ef] rounded-3xl border border-[#d9e2ef]">
                                        {article.faqs.map((faq) => (
                                            <div key={faq.question} className="p-5">
                                                <h3 className="text-xl font-semibold text-[#101828]">{faq.question}</h3>
                                ...
                                <section className="mt-12">
                                    <h2 className="text-3xl font-semibold text-[#101828]">Conclusion</h2>
                                ...
                                <section className="mt-12 rounded-[2rem] bg-[#101828] p-6 text-white">
                                    ...
                                    <div className="mt-6 flex flex-col gap-3 sm:flex-row">
                                        <Link href="/signup" className="inline-flex items-center justify-center gap-2 rounded-2xl bg-primary px-5 py-3 font-semibold text-black">
                                            Start with 3 trial analyses
                                            <FiArrowRight />
                                        </Link>
                                        <Link href="/contact" className="inline-flex items-center justify-center rounded-2xl border border-white/20 px-5 py-3 font-semibold text-white">
                                            Contact support
                                        </Link>
                                    </div>
                                </section>
                                ...
                                <section className="mt-12">
                                    <h2 className="text-3xl font-semibold text-[#101828]">References and further reading</h2>
                                    <ul className="mt-5 space-y-3">
                            ...
                            <aside className="space-y-6">
                                <div className="sticky top-28 space-y-6">
                                    <div className="rounded-[2rem] border border-[#d9e2ef] bg-white p-5 shadow-sm">
                                        <h2 className="text-xl font-semibold text-[#101828]">Related articles</h2>
                                    ...
                                    <div className="rounded-[2rem] border border-[#d9e2ef] bg-white p-5 shadow-sm">
                                        <h2 className="flex items-center gap-2 text-xl font-semibold text-[#101828]"><FiTag /> Tags</h2>
