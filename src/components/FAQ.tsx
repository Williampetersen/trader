            ...
            <div className="flex flex-col lg:flex-row gap-10">
                <div className="">
                    ...
                    <p className="lg:mt-10 text-foreground-accent text-center lg:text-left">
                        Questions about chart uploads, plans, or launch setup?
                    </p>
                    <a href="mailto:support@gptchartview.com" className="mt-3 block text-xl lg:text-4xl text-secondary font-semibold hover:underline text-center lg:text-left">support@gptchartview.com</a>
                </div>
